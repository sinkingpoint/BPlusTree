...
public class BPlusTreeInternalNode<K extends Comparable<K>, V> implements BPlusTreeNode<K, V>{
	...
	private KeyValuePair<K, Integer> dealWithPromote(KeyValuePair<K, Integer> krc){
		...
		if(children.size() <= MAX_INTERNAL_SIZE)return null;
